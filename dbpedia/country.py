...
class CurrencyofQuestion(QuestionTemplate):
    """
    Regex for Wquestions about what is the currency of a country.
    """

    what_is_opening = Lemma("what") + Token("is") + Question(Pos("DT"))
    currency_of = Lemma('currency') + Pos('IN') + Country() + Question(Pos("."))
    regex = what_is_opening + currency_of | currency_of
